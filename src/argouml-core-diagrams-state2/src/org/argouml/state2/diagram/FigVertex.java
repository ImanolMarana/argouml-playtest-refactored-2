...
public class FigVertex extends FigNodeModelElement {
    ...
    private Object findRegion(Fig encloser, LayerPerspective lp) {
        Object region = null;
        if (encloser != null) {
            region = findRegionInEncloser(encloser);
        } else {
            region = findRegionInDiagram(lp);
        }
        return region;
    }

    private Object findRegionInDiagram(LayerPerspective lp) {
        Object region;
    ...
    private Object findRegionInEncloser(Fig encloser) {
        Object region;
