...
class ModelManagementFactoryEUMLImpl implements ModelManagementFactory,
    ...
    public void setRootModel(Object rootModel) {
        ...
        List<EObject> restoreList = getRestoreList(rootModel);
        updateRootModel(rootModel, restoreList);
        modelImpl.getModelEventPump().setRootContainer(theRootModel);
    }
    
    private List<EObject> getRestoreList(Object rootModel) {
    ...
    private void updateRootModel(Object rootModel, List<EObject> restoreList) {
