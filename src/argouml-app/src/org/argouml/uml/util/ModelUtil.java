...
public class ModelUtil {
    ...
    private static void processClassifier(Object classifier) throws IllegalModelElementConnectionException {
        ...
        if (Model.getFacade().getNamespace(namespace) != null) {
            ...
            addClientDependencyNamespaces(classifier, dependentNamespaces);
            addGeneralizationNamespaces(classifier, dependentNamespaces);
            addAssociationNamespaces(classifier, dependentNamespaces);

            createPackageDependencies(namespace, dependentNamespaces);
        }
    }

    private static void addClientDependencyNamespaces(Object classifier, Set dependentNamespaces) {
    ...
    private static void addGeneralizationNamespaces(Object classifier, Set dependentNamespaces) {
    ...
    private static void addAssociationNamespaces(Object classifier, Set dependentNamespaces) {
    ...
    private static void createPackageDependencies(Object namespace, Set dependentNamespaces) throws IllegalModelElementConnectionException {
